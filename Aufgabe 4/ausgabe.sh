...
echo -e "\nAusgabe des Kommandos 'od -t x4 /dev/urandom | head -1 | cut -c 17-32 | sed -e "s/ //g"'"
echo "Mit cut -c 17-32 wird der Inhalt von Zeichen 17 bis 32 ausgegeben."
od -t x4 /dev/urandom | head -1 | cut -c 17-32 | sed -e "s/ //g"
