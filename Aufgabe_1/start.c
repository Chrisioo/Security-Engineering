...
/**
 * Funktion zur Ausgabe von Informationen über das Signal, das den Prozess beendet hat.
 * @param status der Terminationsstatus des Prozesses
 */
...
int main(int argc, char **argv) {
    ...
    if (pid < 0) {                                                                      // Überprüfen, ob fork() fehlgeschlagen ist
        ...
        print_signal_info(status);                                                      // Informationen über das Signal ausgeben, das den Prozess beendet hat (falls zutreffend)
    }
